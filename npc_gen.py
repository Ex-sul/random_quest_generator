...
def quirk_gen(n):
    ...
    quirks_2 = ["wears {} to remember {} {} {}".format(quirks_jewelry(), NPC.poss, quirks_people_circ(), quirks_people(NPC)),
                ...
                "is receiving unwanted attention from {} {} {}".format(NPC.poss, quirks_people_circ(),
                                                                       quirks_people(NPC)),
                "has an odd relationship with {} {}".format(NPC.poss, quirks_people(NPC)),
                "has an embattled relationship with {} {}".format(NPC.poss, quirks_people(NPC)),
                "is alienated from {} {}".format(NPC.poss, quirks_people(NPC)),
                "is obsessed with {} {}".format(NPC.poss, quirks_people(NPC)),
                "is trying to resurrect {} {}".format(NPC.poss, quirks_people(NPC)),
                "is often visited by {} dead {} in {} dreams".format(NPC.poss, quirks_people(NPC), NPC.poss),
                "is sometimes visited by visions of {} dead {}".format(NPC.poss, quirks_people(NPC)),
                "is hiding {} {} from the authorities".format(NPC.poss, quirks_people(NPC)),
                "is hiding {} {} from an angry mob".format(NPC.poss, quirks_people(NPC)),
                "is hiding {} {} from {} {}".format(NPC.poss, quirks_people(NPC), NPC.poss, quirks_people(NPC)),
                "{} that {} {} is hiding {} {} from {}".format(quirks_thinks(), NPC.poss, quirks_people(NPC), NPC.poss,
                                                               quirks_people(NPC), NPC.obj),
                "is planning to intervene between {} {} and {} {}".format(NPC.poss, quirks_people(NPC), NPC.poss,
                                                                          quirks_people(NPC))
                ]
    # ORGANIZATIONS
    quirks_org = ["has received a death threat from {}".format(quirks_organizations()),
                  ...
                  "is trying to talk {} out of accepting {} {}".format(quirks_organizations(), NPC.poss, quirks_people(NPC)),
                  "is trying to join {} to impress {} {}".format(quirks_organizations(), NPC.poss, quirks_people(NPC)),
                  "is trying to join {} to impress {} {} {}".format(quirks_organizations(), NPC.poss, quirks_people_circ(), quirks_people(NPC)),
                  "is trying to join {} to spite {} {}".format(quirks_organizations(), NPC.poss, quirks_people(NPC)),
                  "is trying to join {} to spite {} {} {}".format(quirks_organizations(), NPC.poss, quirks_people_circ(), quirks_people(NPC)),
                  "left {} for {} {}".format(quirks_organizations(), NPC.poss, quirks_people(NPC)),
                  "left {} for {} {} {}".format(quirks_organizations(), NPC.poss, quirks_people_circ(), quirks_people(NPC)),
                  "had to choose between {} and {} {}".format(quirks_organizations(), NPC.poss, quirks_people(NPC)),
                  "will have to choose between {} and {} {}".format(quirks_organizations(), NPC.poss, quirks_people(NPC)),
                  "had to choose between {} and {}".format(quirks_organizations(), quirks_organizations()),
                  "will have to choose between {} and {}".format(quirks_organizations(), quirks_organizations()),
                  "had to choose between {} and {} {} {}".format(quirks_organizations(), NPC.poss, quirks_people_circ(), quirks_people(NPC)),
                  "is trying to get {} {} to leave {} ".format(NPC.poss, quirks_people(NPC), quirks_organizations()),
                  "arrived at the same time that a resurgence of magic occurred in the land and is now the target of {}".format(quirks_organizations()),
                  "has recently been inducted into {}".format(quirks_organizations()),
                  "is the purported founder of {}".format(quirks_organizations()),
                  "is somehow connected to the dissolution of {}".format((quirks_organizations())),
                  "wants to found {} for {} {}".format(quirks_organizations(), NPC.poss, quirks_people(NPC)),
                  "{} magic will break up {}".format(random.choice(["thinks", "hopes", "fears"]), quirks_organizations()),
                  "{} internal corruption will destroy {}".format(random.choice(["thinks", "hopes", "fears"]), quirks_organizations()),
                  "{} a rival will take over {}".format(random.choice(["thinks", "hopes", "fears"]), quirks_organizations()),
                  "is receiving unwanted attention from {}".format(quirks_organizations()),
                  "stumbled upon a private meeting of {}".format(quirks_organizations()),
                  "is hiding {} {} from {}".format(NPC.poss, quirks_people(NPC), quirks_organizations()),
                  "is hiding {} {} {} from {}".format(NPC.poss, quirks_people_circ(), quirks_people(NPC), quirks_organizations()),
                  "{} that {} is hiding {} {} from {}".format(quirks_thinks(), quirks_organizations(), NPC.poss, quirks_people(NPC), NPC.obj),
                  "{} that {} {} left {} to join {}".format(quirks_thinks(), NPC.poss, quirks_people(NPC), NPC.obj, quirks_organizations()),
                  "{} that {} {} is hiding from {} in {}".format(quirks_thinks(), NPC.poss, quirks_people(NPC), NPC.obj, quirks_organizations()),
                  "is trying to {} {}".format(random.choice(["placate", "appease", "impress", "defame", "destroy", "disband", "become leader of"]), quirks_organizations()),]
